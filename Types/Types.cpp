...
namespace roe
{
  ...
  {
    auto* arrayType =
      llvm::ArrayType::get(llvm::Type::getInt8Ty(context), String::size);
    ...
    valueTyToPointerTy_ = TypeMapping{{stringType_, stringPtrType_},
                                      {longType_, longPtrType_},
                                      {floatType_, floatPtrType_}};

    pointerTyToValueTy_ = TypeMapping{{stringPtrType_, stringType_},
                                      {longPtrType_, longType_},
  ...
  llvm::Type* Types::longType() { return longType_; }

  llvm::Type* Types::longPtrType() { return longPtrType_; }

  llvm::Type* Types::charPtrType() { return charPtrType_; }

  llvm::Type* Types::stringType() { return stringType_; }

  llvm::Type* Types::stringPtrType() { return stringPtrType_; }

  llvm::Type* Types::voidPtrType() { return charPtrType(); };

  llvm::Type* Types::boolType() { return boolType_; };

  llvm::Type* Types::voidType() { return voidType_; };

  llvm::Type* Types::floatPtrType() { return floatPtrType_; };

  llvm::Type* Types::floatType() { return floatType_; };

  Types::Types(Context& context) { init(context); }
}
